...
public class ModeratorDashboardController {
    ...
    @Operation(
        summary = "Danh sách tài liệu chờ duyệt",
        description = "Trả về danh sách tất cả tài liệu có visibility = PENDING"
    )
    ...
    @Operation(
        ...
        description = "Phê duyệt một tài liệu chờ duyệt, cập nhật visibility thành PUBLIC"
    )
    ...
    @Operation(
        ...
        description = "Từ chối một tài liệu chờ duyệt, cập nhật visibility thành PRIVATE và lưu lý do"
    )
